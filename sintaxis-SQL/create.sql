/*
este comando muestra todas las bases de
de datos existenten o tablas que ahi en la base de datos
*/
SHOW DATABASES;



#El siguiente query lo que hace es eliminar una tabla o base de datos
...
#El siguiente sql me describe la tabla
DESCRIBE authors;



#AQUI SE VE COMO SE CREAN TABLAS CON SQL
CREATE TABLE `books` (
